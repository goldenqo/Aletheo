...
contract FoundingEvent {
	...
	constructor() {_deployer = msg.sender; _letToken=0x7DA2331C522D4EDFAf545d2F5eF61406D9d637A9;}
	...
	function depositFtm() external payable {
		...
		if(address(this).balance>=hardcap||block.number>=21000000){_createLiquidity();}
	}
