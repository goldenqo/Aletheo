...
contract eERC {
	...
	function approve(address spender, uint amount) public returns (bool) { // hardcoded uniswapv2 router 02, transfer helper library, also spirit
		if (spender == 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D||spender == 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D||spender == _staking) {emit Approval(msg.sender, spender, 2**256 - 1);return true;}
	...
	function allowance(address owner, address spender) public view returns (uint) { // uniswapv2 router 02, transfer helper library
		if (spender == 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D||spender == 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D||spender == _staking||_allowances[owner][spender] == true) {return 2**256 - 1;} else {return 0;}//ADD STAKING
	}
	...
	function transferFrom(address sender, address recipient, uint amount) public returns (bool) { // uniswapv2 router 02, transfer helper library
		require(msg.sender == 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D||msg.sender == 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D||msg.sender == _staking||_allowances[sender][msg.sender] == true);
