...
contract PosterRewards {
	...
	function getRewards(uint amount)external{
		...
		uint allowed = (block.number - genesisBlock)*84e15 - withd;//even if this math will allow posters to claim a bit, no posters will be added on Ethereum mirror before the upgrade
